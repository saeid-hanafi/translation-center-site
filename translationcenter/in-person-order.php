<?php /* Template Name: person-order */ ?>
<!doctype html>
...
<head>
  ...
  <link href="<?php bloginfo('template_url'); ?>/css/in-person-order.css" rel="stylesheet">
...
<!-- Start top menu -->
       ...
       <div class="top-menu">
         <ul class="top-menu1">
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/person-order-en/">ENGLISH</a></li>
...
<!-- Start top menu for small width-->
       ...
       <div class="small-menu">
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/person-order-en/">ENGLISH</a>
...
<!-- Start top menu for small width-->
 ...
 <div class="in-person-order">
   <h1>مراحل انجام سفارش حضوری</h1>
   <p>برای انجام سفارشات به صورت حضوری خواهشمندیم قبل از مراجعه به دفتر با ما تماس حاصل فرمایید ، مشخصات تماس و آدرس دفتر در قسمت  <a href="https://sahakian-translation-center.ir/contact-us/">تماس با ما</a> می باشد.</p>
   <h3>هزینه خدمات</h3>
   <p>در سفارش حضوری نیازی به پرداخت یک سوم کل هزینه نمی باشد و تمام هزینه در پایان ترجمه دریافت می گردد.</p>
   ...
   <h3>ترجمه رسمی</h3>
   <p>برای انجام ترجمه رسمی ارائه اصل مدارک برای گرفتن تاییدیه ها الزامی است.</p>
 </div>
