<?php /* Template Name: online-order-en */ ?>
<!doctype html>
...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/online-order-en.css">
...
Services fee</a></li>
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/online-order/">فارسی</a></li>
...
Services fee</a></li>
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/online-order/">فارسی</a>
...
<!-- End top menu for small width-->
 ...
 <!-- Online order diisions -->
 <div class="online-order">
   <h1>
Online ordering process</h1>
   <h3>First step</h3>
   <p>
Firstly, dear customers must go to the <a href="https://sahakian-translation-center.ir/online-services-en/"> Online Order Registration </a> section and fill out the relevant form carefully and send it to us.</p>
   <h3>Second step</h3>
   <p>After submitting  form, our consultants will calculate your translation fee and will contact you in the shortest possible time and explain the cost and terms of the translation. </p>
   <h3>
How to pay</h3>
   <p>After contact our consultants with you and approving the relevant fee by you, you must deposit a third of the total fee into the translation center account to begin translating and the rest will be paid at the end of the work. <br>
     If the translation is canceled, the prepaid will not be refunded.
   </p>
   <h3>Translation time</h3>
   <p>
If your translation is one until three pages, it will be done within 24 hours, and if there is more, it will be announced when call our consultants receive.</p>
   <h3>
Delivery Method</h3>
   <p>If the translation is unofficial,after the translation is completed,some of the text will be sent as an example for the costumer and after pay full translation fee,the translation will be sent for the costumer. <br> <br>
  In the official translation, dear customers should  in-person payment and recieve the translation.</p>
     <h3>Books and long texts</h3>
   <p>In the translation of books and long texts, first a few pages of free for sample are translated and, if the costumer is satisfied and pay a third of the translation fee,the translation will be do.<br>
   Prepayments will not be refunded if the translation is canceled by the costumer.</p>
   <h3>
Official translation</h3>
   <p>If the costumer requests an official translation, he or she must submit the original documents in person after the translation is completed, as it is required for getting confirmations.</p>
