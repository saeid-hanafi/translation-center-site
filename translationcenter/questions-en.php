<?php /* Template Name: questions-en */ ?>
<!doctype html>
...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/questions-en.css">
...
Services fee</a></li>
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/questions/">فارسی</a></li>
...
Services fee</a></li>
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/questions/">فارسی</a>
...
Frequently Asked Questions</h1>
  <ol>
    <li><h3>
How long does it take to translate the documents?</h3></li>
    <p>If the translation text is between one to three pages, the translation takes place within 24 hours, and if it is longer than three pages, it should be viewed by our consultants to calculate the time required and be reported to the costumer.</p>
    <li><h3>
How much does it cost to translate the documents?</h3></li>
    <p>If the translation text is between one to three pages, it is calculated as a pagely and, if more than three pages, as wordly.<br>
  The cost of official and unofficial translation is the same,only for the official translation 
the cost of receiving endorsements is added.<br>
  
Contact our consultants for the exact cost of your translation.</p>
  <li><h3>Do you need to provide original of documents to translate a documents?</h3></li>
  <p>
Only for official translation is required to provide original of documents.</p>
  <li><h3>
Is it possible to re-order the translation of documents?</h3></li>
  <p>Yes,of course.</p>
  <li><h3>How much does the again translation cost?</h3></li>
  <p>The cost of second time will be half.</p>
  </ol>
</div>
