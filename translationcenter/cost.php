...
<head>
  ...
  <link href="<?php bloginfo('template_url'); ?>/css/cost.css" rel="stylesheet">
...
<!-- Start top menu -->
       ...
       <div class="top-menu">
         <ul class="top-menu1">
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/cost-en/">ENGLISH</a></li>
...
<!-- Start top menu for small width-->
       ...
       <div class="small-menu">
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/cost-en/">ENGLISH</a>
...
<!-- Start top menu for small width-->
 ...
 <div class="cost">
   <h1>هزینه خدمات</h1>
   <p>دارالترجمه رسمی ساهاکیان به علت ارائه خدمات بسیار متنوع و گسترده از جمله ترجمه تمامی مقالات،متون،مدارک شخصی،مدارک اداری،کتب و ... به     تمامی زبان های دنیا قادر به ارائه قیمت های ترجمه به صورت جزئی نمی باشد از این رو تعرفه ها به صورت کلی به شرح زیر است:</p>
   <ul>
     <li>ترجمه تمامی مدارک و متون تا سقف سه صفحه به صورت صفحه ای محاسبه می گردد.</li>
     <li>ترجمه تمامی مدارک و متون بیشتر از سه صفحه به صورت کلمه ای محاسبه می گردد.</li>
     <li>تعرفه ترجمه رسمی و غیر رسمی یکسان بوده و فقط هزینه اخذ تاییدیه وزارت امور خارجه و سفارت به ترجمه رسمی اضافه می گردد.</li>
     <li>برای اطلاع از هزینه دقیق ترجمه خود می توانید با کارشناسان ما تماس حاصل فرمایید.</li>
   </ul>
 </div>
