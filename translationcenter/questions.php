...
<!-- Start top menu -->
       ...
       <div class="top-menu">
         <ul class="top-menu1">
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/questions-en/">ENGLISH</a></li>
...
<!-- Start top menu for small width-->
       ...
       <div class="small-menu">
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/questions-en/">ENGLISH</a>
...
<div class="questions">
  <h1>سوالات متداول</h1>
  <ol>
    <li><h3>مدت زمان مورد نیاز برای ترجمه اسناد و مدارک چقدر است؟</h3></li>
    <p>در صورتی که متن ترجمه بین یک تا سه صفحه باشد در مدت 24 ساعت ترجمه صورت می گیرد و اگر بیشتر باشد باید توسط مشاوران ما مشاهده شود تا مدت زمان مورد نیاز محاسبه و به مشتری اعلام گردد.</p>
    <li><h3>هزینه ترجمه اسناد و مدارک چقدر است؟</h3></li>
    <p>در صورتی که متن ترجمه بین یک تا سه صفحه باشد به صورت صفحه ای و اگر بیشتر باشد به صورت کلمه ای محاسبه می گردد.<br>
    هزینه ترجمه رسمی و غیر رسمی یکسان بوده فقط در ترجمه رسمی هزینه دریافت تاییدیه ها به مبلغ ترجمه افزوده می شود.<br>
  برای اطلاع از هزینه دقیق ترجمه خود با مشاوران ما تماس حاصل فرمائید.</p>
  <li><h3>برای ترجمه یک مدرک آیا باید اصل مدرک را ارائه داد؟</h3></li>
  <p>فقط برای ترجمه رسمی ارائه اصل مدرک الزامی است.</p>
  <li><h3>آیا امکان سفارش دوباره ترجمه مدارک وجود دارد؟</h3></li>
  <p>بله وجود دارد.</p>
  <li><h3>هزینه ترجمه دوباره چقدر است؟</h3></li>
  <p>هزینه دفعه دوم نصف می گردد.</p>
  </ol>
</div>
