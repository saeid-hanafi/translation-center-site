<?php /* Template Name: person-order-en */ ?>
<!doctype html>
...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/person-order-en.css">
...
Services fee</a></li>
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/person-order/">فارسی</a></li>
...
Services fee</a></li>
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/person-order/">فارسی</a>
...
<!-- End top menu for small width-->
 ...
 <!-- In person order divisions -->
 <div class="in-person-order">
   <h1>
Steps to order in person</h1>
   <p>For orders in person please contact us before visiting the office, contact details and office address are in <a href="https://sahakian-translation-center.ir/contact-us-en/">the Contact Us</a> section.</p>
   <h3>Services fee</h3>
   <p>One-third of the total cost is not required for ordering in person and the total cost will be recieve at the end of the work.</p>
...
Official translation</h3>
   <p>
For official translation is required submitting the original documents for obtaining confirmations.</p>
 </div>
