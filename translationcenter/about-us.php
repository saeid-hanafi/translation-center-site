...
<head>
  ...
  <link href="<?php bloginfo('template_url'); ?>/css/about-us.css" rel="stylesheet">
...
<!-- Start top menu -->
       ...
       <div class="top-menu">
         <ul class="top-menu1">
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/about-us-en/">ENGLISH</a></li>
...
<!-- Start top menu for small width-->
       ...
       <div class="small-menu">
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/about-us-en/">ENGLISH</a>
...
<div class="about-us">
  <h1>درباره ما</h1>
  <p>دارالترجمه رسمی ساهاکیان با بیش از دو دهه فعالیت در حوزه ترجمه و همچنین مهاجرت در کشور ارمنستان با سابقه کار با سازمان های رسمی کشور ارمنستان اعم از وزارت امور خارجه،وزارت دادگستری،کانون وکلاء و سفارت جمهوری اسلامی ایران با مدیریت وکیل پایه یک و مترجم با سابقه آقای الکساندر ساهاکیان که خود به زبان های فارسی،ارمنی،روسی،انگلیسی تسلط کامل دارند آماده ارائه خدمات به مشتریان عزیز می باشد.</p>
</div>
