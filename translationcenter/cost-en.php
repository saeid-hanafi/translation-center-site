...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/cost-en.css">
...
Services fee</a></li>
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/cost/">فارسی</a></li>
...
Services fee</a></li>
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/cost/">فارسی</a>
...
<!-- End top menu for small width-->
 ...
 <!-- Cost of services division -->

 <div class="cost">
   <h1>
Service fee</h1>
   <p>
The Sahakian Translation Center offers a wide range of services including translation of all articles, texts, personal documents, administrative documents, books and ... to all languages ​​worldwide, so it is not able to offer partial translation prices. These are generally as follows:</p>
   <ul>
     <li>The translation of all documents and texts up to a three-page is calculated pagely.</li>
     <li>
Translating all documents and texts into more than three pages is calculated wordly.</li>
     <li>
The official and unofficial translation tariffs are the same, with only the cost of obtaining State Department and Embassy approval being added to the official translation.</li>
     <li>
You can contact our experts for the exact cost of your translation.</li>
   </ul>
 </div>
