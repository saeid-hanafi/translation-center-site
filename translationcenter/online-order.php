...
<head>
  ...
  <link href="<?php bloginfo('template_url'); ?>/css/online-order.css" rel="stylesheet">
...
<!-- Start top menu -->
       ...
       <div class="top-menu">
         <ul class="top-menu1">
           ...
           <li><a class="lang" href="https://sahakian-translation-center.ir/online-order-en/">ENGLISH</a></li>
...
<!-- Start top menu for small width-->
       ...
       <div class="small-menu">
         ...
         <a class="lang" href="https://sahakian-translation-center.ir/online-order-en/">ENGLISH</a>
...
<!-- Start top menu for small width-->
 ...
 <div class="online-order">
   <h1>مراحل انجام سفارش آنلاین</h1>
   <h3>مرحله اول</h3>
   <p>در مرحله اول مشتریان عزیز باید به قسمت  <a href="https://sahakian-translation-center.ir/online-services/">ثبت سفارش آنلاین</a> بروند و فرم مربوطه را با دقت پر کرده و برای ما ارسال کنند.</p>
   <h3>مرحله دوم</h3>
   <p>پس از ارسال فرم مشاوران ما هزینه ترجمه شما را محاسبه کرده و در کمترین زمان ممکن با شما تماس خواهند گرفت و هزینه و شرایط ترجمه را برای شما توضیح خواهند داد در صورت تایید شما ترجمه شما در کمترین زمان ممکن و به بهترین شکل انجام خواهد شد.</p>
   <h3>نحوه پرداخت هزینه</h3>
   <p>پس از تماس مشاوران ما با شما و تایید هزینه مربوطه توسط شما ، برای شروع ترجمه شما باید یک سوم کل هزینه را به حساب دارالترجمه واریز کنید و الباقی هزینه در پایان کار دریافت می گردد.<br>
     در صورت لغو شدن ترجمه توسط مشتری پیش پرداخت بازگردانده نمی شود.
   </p>
   <h3>مدت زمان ترجمه</h3>
   <p>اگر ترجمه شما یک تا سه صفحه باشد در مدت 24 ساعت انجام می شود و اگر بیشتر باشد در تماسی که مشاوران ما با شما می گیرند اعلام می شود.</p>
   <h3>نحوه تحویل</h3>
   <p>در صورتی که ترجمه غیر رسمی باشد پس از پایان ترجمه مقداری از متن به عنوان نمونه برای مشتری ارسال می گردد در صورت رضایت و پرداخت الباقی هزینه ترجمه کامل برای مشتری ارسال می گردد همچنین مشتریان عزیز می توانند به صورت حضوری برای دریافت ترجمه و پرداخت هزینه اقدام کنند.<br>
  در ترجمه رسمی مشتریان عزیز باید بعد از انجام ترجمه به صورت حضوری برای دریافت ترجمه و پرداخت هزینه اقدام کنند.</p>
     <h3>کتب و متون طولانی</h3>
   <p>در ترجمه کتب و متون طولانی در اول کار چند صفحه به صورت رایگان برای نمونه ترجمه می گردد در صورت رضایت مشتری پس از پرداخت یک سوم هزینه ترجمه انجام می شود.<br>
   در صورت لغو شدن ترجمه توسط مشتری مبلغ پیش پرداخت بازگردانده نمی شود.</p>
   <h3>ترجمه رسمی</h3>
   <p>در صورتی که مشتری درخواست ترجمه رسمی داشته باشد باید اصل مدرک را به صورت حضوری بعد از پایان ترجمه به دست ما برساند زیرا برای دریافت تاییدیه ها الزامی است.</p>
